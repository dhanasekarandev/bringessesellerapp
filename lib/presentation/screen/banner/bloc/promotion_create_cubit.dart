...
class PromotionCreateCubit extends Cubit<PromotionCreateState> {
  AuthRepository authRepository;

  PromotionCreateCubit({required this.authRepository})
      : super(PromotionCreateState.initial());

  void login(storeUploadReqModel) async {
    emit(state.copyWith(networkStatusEnum: NetworkStatusEnum.loading));

    (bool, dynamic) response =
        await authRepository.PromotionCreate(storeUploadReqModel);
